...
switch(request.action){
    	...
    	"<p style='color:#163B5A;'>To activate your account follow the link  <a style='color:#8d1313;text-decoration: none;' href='http://localhost:9000/#/activate/"+request.token+"'>activate</a></p>";
    	...
    	var html = "<img src='http://i66.tinypic.com/1z2m64k.png' style='width:350px;height:128px;'><br/>"+
    	"<p style='color:#163B5A;'>To restart your password follow the link <a style='color:#8d1313;text-decoration: none;' href='http://localhost:9000/#/reset/"+request.token+"'>Restart Pass</a></p>";
    ...
    var html = "<img src='http://i66.tinypic.com/1z2m64k.png' style='width:350px;height:128px;'><br/>"+
      "<p style='color:#163B5A;'>Before you restart your password you must activate it<a style='color:#8d1313;text-decoration: none;' href='http://localhost:9000/#/activate/"+request.token+"'>activate</a></p>";
      var subject = "Meanstack activate account";
